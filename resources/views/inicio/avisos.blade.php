    ...
    <div class="cmpnt cmpnt-carousel">
        <div class="carousel slide" data-interval="12000" data-ride="carousel-avisos" id="carousel-avisos">
            ...
            <div class="carousel-inner" role="listbox">
                ...
                <div class="item">
                        <picture>
                            <source media="(min-width: 465px)" srcset="https://www.movilidadbogota.gov.co/web/sites/default/files/Noticias/16-08-2024/apertura_nuestrobogota_banner1.jpg"> <img alt="Ir a Plan piloto de salida" class="img-responsive w-100" src="https://www.movilidadbogota.gov.co/web/sites/default/files/Noticias/16-08-2024/apertura_nuestrobogota_banner2.jpg" title="Image: Plan piloto de salida">
                        </picture>
                    </div>

                <div class="item"><a href="https://www.movilidadbogota.gov.co/web/sites/default/files/Paginas/12-08-2024/abece_plan_piloto_de_salida_v_5_0.pdf" target="_blank">
                        <picture>
                            <source media="(min-width: 465px)" srcset="https://www.movilidadbogota.gov.co/web/sites/default/files/Noticias/12-08-2024/banner-plan-piloto-salida-desktop.png"> <img alt="Ir a Plan piloto de salida" class="img-responsive w-100" src="https://www.movilidadbogota.gov.co/web/sites/default/files/Noticias/12-08-2024/banner-plan-piloto-salida-mobile.png" title="Image: Plan piloto de salida">
                        </picture>
                    </a></div>

                <div class="item"><a href="http://bogota.gov.co/">
                        <picture>
                            <source media="(min-width: 465px)" srcset="https://www.movilidadbogota.gov.co/web/sites/default/files/Paginas/05-08-2024/banners_486_anos_950x300.png"> <img alt="Ir a Bogotá mi ciudad mi casa" class="img-responsive w-100" src="https://www.movilidadbogota.gov.co/web/sites/default/files/Paginas/05-08-2024/banners_486_anos_340x300.png" title="Image: Bogotá mi ciudad mi casa">
                        </picture>
                    </a></div>

                <div class="item"><a href="https://bogota.gov.co/">
                        <picture>
                            <source media="(min-width: 465px)" srcset="https://www.movilidadbogota.gov.co/web/sites/default/files/Paginas/05-08-2024/banners_turnos_racionamiento_950x300.png"> <img alt="Ir a turnos de racionamiento" class="img-responsive w-100" src="https://www.movilidadbogota.gov.co/web/sites/default/files/Paginas/05-08-2024/banners_turnos_racionamiento_340x300.png" title="Image: turnos de racionamiento">
                        </picture>
                    </a></div>

                <div class="item">
                    <picture>
                        <source media="(min-width: 465px)" srcset="https://www.movilidadbogota.gov.co/web/sites/default/files/Paginas/02-08-2024/cumplebogota_ago2024_banner1.png"> <img alt="Aviso de suspención de servicios" class="img-responsive w-100" src="https://www.movilidadbogota.gov.co/web/sites/default/files/Paginas/02-08-2024/cumplebogota_ago2024_banner2.png" title="Image: Aviso de suspención de servicios">
                    </picture>
                </div>

                <div class="item"><a href="https://webfenix.movilidadbogota.gov.co/#/consulta-pagos">
                        <picture>
                            <source media="(min-width: 465px)" srcset="https://www.movilidadbogota.gov.co/web/sites/default/files/Paginas/19-07-2024/banner-amnistias-desktop.png"> <img alt="Aviso amnistias" class="img-responsive w-100" src="https://www.movilidadbogota.gov.co/web/sites/default/files/Paginas/19-07-2024/banner-amnistias-mobile.png" title="Image: Aviso amnistias">
                        </picture>
                    </a></div>

                <div class="item"><a href="https://www.youtube.com/watch?v=6mYhZhLHnX8">
                        <picture>
                            <source media="(min-width: 465px)" srcset="https://www.movilidadbogota.gov.co/web/sites/default/files/Paginas/17-07-2024/solicitud_prioritaria_banners_bogota_mi_ciudad_mi_casa_950x300.png"> <img alt="Aviso Bogotá Mi Ciudad, Mi Casa" class="img-responsive w-100" src="https://www.movilidadbogota.gov.co/web/sites/default/files/Paginas/17-07-2024/solicitud_prioritaria_banners_bogota_mi_ciudad_mi_casa_340x300.png" title="Image: Aviso Bogotá Mi Ciudad, Mi Casa">
                        </picture>
                    </a></div>

                <div class="item"><a href="https://www.movilidadbogota.gov.co/web/noticia/a_partir_del_22_de_julio_inicia_la_operacion_del_nuevo_carril_preferencial_en_la_carrera_13">
                        <picture>
                            <source media="(min-width: 465px)" srcset="https://www.movilidadbogota.gov.co/web/sites/default/files/Noticias/17-07-2024/3.-banner-web950x300.jpg"> <img alt="Aviso a partir del 22 de julio inicia la operacion del nuevo carril preferencial en la carrera 13" class="img-responsive w-100" src="https://www.movilidadbogota.gov.co/web/sites/default/files/Noticias/17-07-2024/3.-banner-web-340x300.jpg" title="Image: Aviso a partir del 22 de julio inicia la operacion del nuevo carril preferencial en la carrera 13">
                        </picture>
                    </a></div>

                <div class="item">
                    <picture>
                        <source media="(min-width: 465px)" srcset="https://www.movilidadbogota.gov.co/web/sites/default/files/Paginas/12-07-2024/agendamiento_jul2024_950x300.png"> <img alt="Ir a Agendamiento Virtual" class="img-responsive w-100" src="https://www.movilidadbogota.gov.co/web/sites/default/files/Paginas/12-07-2024/agendamiento_jul2024_340x300.png" title="Image: Agendamiento virtual">
                    </picture>
                </div>

                <div class="item"><a href="https://www.movilidadbogota.gov.co/web/plan_distrital_de_desarrollo_2024_2027">
                        <picture>
                            <source media="(min-width: 465px)" srcset="https://www.movilidadbogota.gov.co/web/sites/default/files/Paginas/16-07-2024/banners_aprobado_el_pdd_bogota_camina_segura_950x300.png"> <img alt="Ir a Plan de Desarrollo Distrital" class="img-responsive w-100" src="https://www.movilidadbogota.gov.co/web/sites/default/files/Paginas/16-07-2024/banners_aprobado_el_pdd_bogota_camina_segura_340x300.png" title="Image: Plan de Desarrollo Distrital">
                        </picture>
                    </a></div>

                <div class="item"><a href="https://picoyplacasolidario.movilidadbogota.gov.co/PortalCiudadano/#/">
                        <picture>
                            <source media="(min-width: 465px)" srcset="https://www.movilidadbogota.gov.co/web/sites/default/files/Paginas/29-05-2024/pieza_pyp-lg.png"> <img alt="Ir a actualización Pico y Placa Solidario" class="img-responsive w-100" src="https://www.movilidadbogota.gov.co/web/sites/default/files/Paginas/29-05-2024/pieza_pyp-xs.png" title="Image: actualización Pico y Placa Solidario">
                        </picture>
                    </a></div>

                <div class="item"><a href="https://www.movilidadbogota.gov.co/web/cierres_obras_metro">
                        <picture>
                            <source media="(min-width: 465px)" srcset="https://www.movilidadbogota.gov.co/web/sites/default/files/Paginas/14-05-2024/piezas_metro_banners_banner_950x300.png"> <img alt="Ir a cierre estación Transmilenio calle 26" class="img-responsive w-100" src="https://www.movilidadbogota.gov.co/web/sites/default/files/Paginas/14-05-2024/piezas_metro_banners_banner_340x300.png" title="Image: cierre estación Transmilenio calle 26">
                        </picture>
                    </a></div>

                <div class="item"><a href="https://www.movilidadbogota.gov.co/web/puntos_de_atencion">
                        <picture>
                            <source media="(min-width: 465px)" srcset="https://www.movilidadbogota.gov.co/web/sites/default/files/Paginas/29-05-2024/gyp_banner_950x300.png"> <img alt="Banner retiro de vehículo inmovilizado" class="img-responsive w-100" src="https://www.movilidadbogota.gov.co/web/sites/default/files/Paginas/29-05-2024/gyp_banner_340x300.png" title="Image: Banner retiro de vehículo inmovilizado">
                        </picture>
                    </a></div>
            ...
            <a class="left carousel-control" data-slide="prev" href="#carousel-avisos" role="button" title="Anterior"><span class="sr-only">Anterior</span></a> <a class="right carousel-control" data-slide="next" href="#carousel-avisos" role="button" title="Siguiente"> <span class="sr-only">Siguiente</span></a>
        </div>
    </div>
