...
@section('contenido')
    ...
    <div class="set-wrapper avisos">
        ...
        <div class="cmpnt cmpnt-banner-principal">
            <br>
            <a href="https://bogota.gov.co/plan-distrital-de-desarrollo-2024-2028/">
                <div class="item zoom bs">
                    <picture>
                        <source media="(min-width: 992px)"
                            srcset="https://www.movilidadbogota.gov.co/web/sites/default/files/Paginas/07-02-2024/banner_1140_x_200.png">
                        <source media="(min-width: 465px)"
                            srcset="https://www.movilidadbogota.gov.co/web/sites/default/files/Paginas/07-02-2024/banner_1140_x_600.png">
                        <img src="https://www.movilidadbogota.gov.co/web/sites/default/files/Paginas/07-02-2024/banner_400x200.png"
                            class="img-responsive w-100" alt="Click aquí para acceder a Te tengo el plan"
                            title="Imagen: Click aquí para acceder a Te tengo el plan">
                    </picture>
                </div>
            </a>
            <hr>
        ...
        <div class="cmpnt cmpnt-carousel">
            <div id="carousel-avisos" class="carousel slide" data-ride="carousel-avisos" data-interval="12000">
                ...
                <div class="carousel-inner" role="listbox">
                    ...
                    <div class="item active">
                        <a href="https://portalmimovilidad.movilidadbogota.gov.co/">
                            <picture>
                                ...
                                <img src="https://www.movilidadbogota.gov.co/web/sites/default/files/Paginas/21-11-2023/banner_mimovilidad_2.png"
                                    class="img-responsive w-100" alt="Mi movilidad a un clic"
                    ...
                    <div class="item">
                        <a
                            href="https://www.movilidadbogota.gov.co/web/noticia/bogota_adelanta_caracterizacion_de_movilidad_a_poblacion_con_discapacidad">
                            <picture>
                                <source media="(min-width: 465px)"
                                    srcset="https://www.movilidadbogota.gov.co/web/sites/default/files/Paginas/12-01-2024/encuestadiscapacidad_0.png">
                                <img src="https://www.movilidadbogota.gov.co/web/sites/default/files/Paginas/21-11-2023/encuesta-discapacidad_330x300.jpg"
                                    class="img-responsive w-100"
                                    alt="ir a encuesta para población en condición de discapacidad"
                                    title="Image: ir a encuesta para población en condición de discapacidad">
                            </picture>
                        </a>
                    </div>
                    <div class="item">
                        <a href="https://www.movilidadbogota.gov.co/web/plan_de_movilidad_sostenible_y_segura">
                            <picture>
                                ...
                                <img src="https://www.movilidadbogota.gov.co/web/sites/default/files/Paginas/17-11-2023/banner-pmss_300x330.png"
                                    class="img-responsive w-100" alt="Ir a Plan de Movilidad Sostenible y Segura"
                    ...
                    <div class="item">
                        <a
                            ...
                            <picture>
                                ...
                                <img src="https://www.movilidadbogota.gov.co/web/sites/default/files/Paginas/21-09-2023/bitacora_senda_integridad_web_340x300.png"
                                    class="img-responsive w-100" alt="Ir a bitácora de la senda de integridad"
                    ...
                    <div class="item">
                        <a href="https://www.ventanillamovilidad.com.co/">
                            <picture>
                                ...
                                <img src="https://www.movilidadbogota.gov.co/web/sites/default/files/Paginas/21-11-2023/salidapatios_banner2.png"
                                    class="img-responsive w-100" alt="Ir a Salida de patios virtual"
                    ...
                    <div class="item">
                        <a
                            ...
                            <picture>
                                ...
                                <img src="https://www.movilidadbogota.gov.co/web/sites/default/files/Paginas/30-05-2023/pantallas_y_creditos_ciclomotores_340x300_web.png"
                                    class="img-responsive w-100"
                                    alt="Ir a Resolución que define la circulación de ciclomotores en Bogotá"
                    ...
                    <div class="item">
                        <a href="http://www.fotodeteccionbogota.com/">
                            <picture>
                                ...
                                <img src="https://www.movilidadbogota.gov.co/web/sites/default/files/Paginas/22-03-2023/banner_foto_detenciones_banner_340x300.png"
                                    class="img-responsive w-100" alt="Ir a Consulta aquí todo acerca de las fotodetecciones"
                ...
                <a class="right carousel-control" href="#carousel-avisos" role="button" data-slide="next"
                    title="Siguiente">
