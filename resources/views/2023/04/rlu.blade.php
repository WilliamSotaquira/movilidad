...
<div class="set-wrapper rlu">
    <style type="text/css">
        ...
        .bg-naranja {
            background: #A6B517 !important;
        }

        .btn-propuesta {
            background: #A6B517;
            border: 2px solid #A6B517;
            color: #fff !important;
            /*width: 100%;*/
            padding: 10px 20px;
            text-align: center;
    ...
    <div align="center"><img alt="Red de Logística Urbana (RLU)" class="img-rounded img-responsive logo-ppal" src="https://www.movilidadbogota.gov.co/web/sites/default/files/Paginas/08-07-2025/RLU_Verde_2.png"></div>

    <div align="center"><img alt="Red de Logística Urbana (RLU)" class="img-rounded img-responsive" src="https://www.movilidadbogota.gov.co/web/sites/default/files/Paginas/06-08-2025/RLU_image.jpg"></div>
    ...
    <div class="panel-group" id="accordion-rlu">
        ...
        <div class="panel panel-primary panel-naranja">
            ...
            <div aria-expanded="false" class="panel-collapse collapse" id="rlu4" style="height: 0px;">
                <div class="panel-body px-0">
                    ...
                    <div align="center"><img alt="Datos relevantes de la Red de Logística Urbana (RLU)" class="img-rounded img-responsive" src="https://www.movilidadbogota.gov.co/web/sites/default/files/Paginas/01-08-2025/Cifras_RLU.png"></div>
                </div>
            </div>
        </div>
        ...
        <div class="panel panel-primary panel-naranja">
            <div class="panel-heading panel-heading-beneficios">
                <h4 class="panel-title"><a aria-expanded="false" class="collapsed" data-parent="#accordion-rlu" data-toggle="collapse" href="#rlu6">Inscripción a la Red de Logística Urbana</a></h4>
            </div>
            ...
            <div aria-expanded="false" class="panel-collapse collapse" id="rlu6" style="height: 0px;">
                <div class="panel-body px-0">
                    <div>
                        ...
                        <p class="text-center"><a class="btn btn-propuesta" href="http://bit.ly/EnCargaTe" target="_blank">Unirse a la RLU</a></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="panel panel-primary panel-naranja">
            ...
            <div aria-expanded="false" class="panel-collapse collapse" id="rlu7" style="height: 0px;">
                <div class="panel-body px-0">
                    <div align="center"><img alt="Red de Logística Urbana (RLU)" class="img-rounded img-responsive" src="https://www.movilidadbogota.gov.co/web/sites/default/files/Paginas/06-08-2025/RLU_image_2.jpg"></div>
                    ...
                    <p>Empresas reconocidas en al año 2024: <a href="https://www.movilidadbogota.gov.co/web/noticia/bogota_reconocio_a_las_empresas_con_las_mejores_practicas_logisticas" rel="noopener noreferrer" target="_blank">https://www.movilidadbogota.gov.co/web/noticia/bogota_reconocio_a_las_empresas_con_las_mejores_practicas_logisticas</a></p>

                    <p style="text-align: justify;">El reconocimiento se entrega anualmente, para el año 2025, se tendrá las siguientes cuatro categorías:</p>

                    <div class="row d-flex">
                        <div class="col-sm-4 d-flex align-items-center">
                            <div align="center"><img alt="Red de Logística Urbana (RLU)" class="img-rounded img-responsive" src="https://www.movilidadbogota.gov.co/web/sites/default/files/Paginas/06-08-2025/1rlu.png"></div>
                        </div>

                        <div class="col-sm-4 d-flex align-items-center">
                            <div align="center"><img alt="Red de Logística Urbana (RLU)" class="img-rounded img-responsive" src="https://www.movilidadbogota.gov.co/web/sites/default/files/Paginas/06-08-2025/2rlu.png"></div>
                        </div>
                        <div class="col-sm-4 d-flex align-items-center">
							<div align="center"><img alt="Red de Logística Urbana (RLU)" class="img-rounded img-responsive" src="https://www.movilidadbogota.gov.co/web/sites/default/files/Paginas/06-08-2025/3rlu.png"></div>
						</div>
                    ...
                    <hr>
                    <div class="row">
                        <div class="col-xs-12 col-sm-6 text-center"><a class="btn btn-propuesta" href="https://forms.gle/ZF4gCnDfi8SF5P4SA" target="_blank">Postulaciones al reconocimiento 2025</a></div>

                        <div class="col-xs-12 col-sm-6 text-center">
                            <p><a class="btn btn-propuesta" href="https://www.movilidadbogota.gov.co/web/sites/default/files/Paginas/06-08-2025/terminos_y_condiciones_de_la_postulacion.zip" target="_blank">Más información</a></p>
                        </div>
                    </div>
        ...
        <div class="panel panel-primary panel-naranja">
            ...
            <div aria-expanded="true" class="panel-collapse collapse" id="rlu8" style="">
                <div class="panel-body px-0"><img alt="Image" class="img-responsive" src="https://www.movilidadbogota.gov.co/web/sites/default/files/Paginas/09-02-2024/proyectos_rlu.jpg">
        ...
        <div class="panel panel-primary panel-naranja">
            ...
            <div aria-expanded="true" class="panel-collapse collapse" id="rlu10" style="">
                <div class="panel-body px-0">
                    ...
                    <p style="color:rgba(77, 84, 31, 1)"><a href="mailto:cargabogota@movilidadbogota.gov.co">cargabogota@movilidadbogota.gov.co</a></p>
