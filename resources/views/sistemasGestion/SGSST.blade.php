...
<link href="https://fonts.googleapis.com/css2?family=Sora:wght@100;200;300;400;500;600;700;800&amp;display=swap" rel="stylesheet"><!-- ----- ----- ----- ----- ----- ----- ----- ----- Bloque Seccion ----- ----- ----- ----- ----- ----- ----- ----- ----- ------ --><!-- Modal Juan Felipe Clavijo -->
<div aria-hidden="true" aria-labelledby="exampleModalLongTitle" class="modal fade" id="modalFelipeClavijo" role="dialog" tabindex="-1">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-body">
				<div class="foto"><img alt="Foto: demo" class="img-responsive w-100" src="https://www.movilidadbogota.gov.co/web/sites/default/files/Paginas/15-09-2023/juanfelipeclavijo.png" title="Foto: demo"></div>

				<div class="texto">
					<h3>Juan Felipe Clavijo</h3>

					<p>Psicólogo, especialista en salud ocupacional y riesgos laborales, asesor de <strong>ARL Positiva</strong> y en el equipo apoya los temas relacionados con las estrategias para la intervención y promoción del riesgo psicosocial.</p>
				</div>
...
<!-- Modal Carolina Marrinez -->

<div aria-hidden="true" aria-labelledby="exampleModalLongTitle" class="modal fade" id="modalCarolinaMartinez" role="dialog" tabindex="-1">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-body">
				<div class="foto"><img alt="Foto: demo" class="img-responsive w-100" src="https://www.movilidadbogota.gov.co/web/sites/default/files/Paginas/15-09-2023/carolinamartinez.png" title="Foto: demo"></div>

				<div class="texto">
					<h3>Carolina Martínez</h3>

					<p>Administradora de Empresas, especialista en seguridad y salud en el trabajo, apoya temas relacionados con identificación de peligros y valoración de riesgos, implementación de controles, Accidentes de Trabajo, Elementos de Protección Personal y Plan Estratégico de Seguridad Vial.</p>
				</div>
...
<div aria-hidden="true" aria-labelledby="exampleModalLongTitle" class="modal fade" id="modalPauletteRivas" role="dialog" tabindex="-1">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-body">
				<div class="foto">
					<div class="imagen"><img alt="Foto: Paulette Rivas" class="img-responsive w-100" src="https://www.movilidadbogota.gov.co/web/sites/default/files/Paginas/06-06-2023/paulette_rivas.webp" title="Foto: Paulette Rivas"></div>
				</div>

				<div class="texto">
					<h3>Paulette Rivas</h3>

					<p>Ingeniera industrial, apoya los temas relacionados con afiliaciones a la ARL, comunicaciones, seguimiento a planes de mejoramiento y las actividades que se requieran para el cumplimiento de los objetivos del sistema.</p>
				</div>
...
<div aria-hidden="true" aria-labelledby="exampleModalLongTitle" class="modal fade" id="modalJessicaMora" role="dialog" tabindex="-1">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-body">
				<div class="foto">
					<div class="imagen"><img alt="Foto: Jessica Mora" class="img-responsive w-100" src="https://www.movilidadbogota.gov.co/web/sites/default/files/Paginas/07-06-2023/jessica_mora.webp" title="Foto: Jessica Mora"></div>
				</div>
...
<div aria-hidden="true" aria-labelledby="exampleModalLongTitle" class="modal fade" id="modalAstridFuentes" role="dialog" tabindex="-1">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-body">
				<div class="foto">
					<div class="imagen"><img alt="Foto: Astrid Fuentes" class="img-responsive w-100" src="https://www.movilidadbogota.gov.co/web/sites/default/files/Paginas/06-06-2023/astridfuentes.png" title="Foto: Astrid Fuentes"></div>
				</div>
				...
				<div class="tab-box"><!-- Tab panes -->
					<div class="tab-content">
						<div class="tab-pane fade" id="tp_uno" role="tabpanel">
							<div class="pane-box">
								<video controls="" style="width: 100%;"><source src="https://www.movilidadbogota.gov.co/web/sites/default/files/Paginas/14-12-2021/braile_alta_v2.mp4" type="video/mp4"></video>
							</div>
						</div>

						<div class="tab-pane fade" id="tp_dos" role="tabpanel">
							<div class="pane-box">
								<video controls="" style="width: 100%;"><source src="https://www.movilidadbogota.gov.co/web/sites/default/files/Paginas/14-12-2021/dia_de_la_emergencia_-_2021.mp4" type="video/mp4"></video>
							</div>
						</div>

						<div class="tab-pane fade" id="tp_tres" role="tabpanel">
							<div class="pane-box">
								<video controls="" style="width: 100%;"><source src="https://www.movilidadbogota.gov.co/web/sites/default/files/Paginas/14-12-2021/video_vacunacion.mp4" type="video/mp4"></video>
							</div>
						</div>

						<div class="tab-pane fade in active" id="tp_cuatro" role="tabpanel">
							<div class="pane-box">
								<video controls="" style="width: 100%;"><source src="https://www.movilidadbogota.gov.co/web/sites/default/files/Paginas/13-10-2022/subtitulado_sst.mp4" type="video/mp4"></video>
							</div>
						</div>
					</div>
					<!-- Nav tabs -->
			...
			<div class="tab-pane fade" id="equipo" role="tabpanel">
				<div class="box-tab">
					...
					<div class="box-equipo">
						...
						<div class="card-profile">
							<div class="foto-perfil "><a data-target="#modalPauletteRivas" data-toggle="modal"><img alt="Paulette Rivas" class="img-responsive w-100 zoom" src="https://www.movilidadbogota.gov.co/web/sites/default/files/Paginas/06-06-2023/paulette_rivas.webp" title="Paulette Rivas"> </a></div>

							<h4><a data-target="#modalPauletteRivas" data-toggle="modal">Paulette Rivas</a></h4>
						</div>
						...
						<div class="card-profile">
							<div class="foto-perfil "><a data-target="#modalJessicaMora" data-toggle="modal"><img alt="Jessica Mora" class="img-responsive w-100 zoom" src="https://www.movilidadbogota.gov.co/web/sites/default/files/Paginas/07-06-2023/jessica_mora.webp" title="Jessica Mora"> </a></div>
						...
						<div class="card-profile">
							<div class="foto-perfil"><a data-target="#modalFelipeClavijo" data-toggle="modal"><img alt="Juan Felipe Clavijo" class="img-responsive w-100 zoom" src="https://www.movilidadbogota.gov.co/web/sites/default/files/Paginas/15-09-2023/juanfelipeclavijo.png" title="Juan Felipe Clavijo"> </a></div>

							<h4><a data-target="#modalFelipeClavijo" data-toggle="modal">Juan Felipe Clavijo</a></h4>
						</div>
						...
						<style type="text/css">.card-profile {
                                    display: grid;
                                    /* gap: 8px; */
                                    grid-auto-flow: dense;
                                    grid-template-columns: 1fr;
					...
					<style type="text/css">.box-equipo {
                                display: grid;
                                gap: 32px;
                                grid-auto-flow: dense;
					...
					<style type="text/css">.box-tab .contacto p {
...
<style type="text/css">.field-name-title h2 {
            visibility: hidden;
            /* margin-top: -180px; */
            height: 0px;
        }
