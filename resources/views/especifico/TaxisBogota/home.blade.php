...
<div class='container-fluid taxis'>
    ...
    <div class="row">
        <div class="col-xs-8 col-xs-offset-2">
            <br>
            <img class="img-responsive w-100 pt-img" src="https://www.movilidadbogota.gov.co/web/sites/default/files/Temas/2022-04-07/taxi1.jpg" alt="Taxi eléctrico de Bogotá">
    ...
    <div class="row">
        <div class="col-xs-8 col-xs-offset-2">
            <br>
            <img class="img-responsive w-100 pt-img" src="https://www.movilidadbogota.gov.co/web/sites/default/files/Temas/2022-04-07/taxi2.jpg" alt="Taxi eléctrico de Bogotá">
