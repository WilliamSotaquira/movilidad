...
<div class="row">
    ...
    <div class="col-xs-12 visible-xs-12 visible-xs-block">
        <img class="img-responsive w-100" src="https://www.movilidadbogota.gov.co/web/sites/default/files/Temas/2021-07-29/banner_si_voy_en_taxi_900_x_300.jpg" alt="Taxis de Bogotá - Servicio legal y de calidad las 24 horas." title="Taxis de Bogotá - Servicio legal y de calidad las 24 horas.">
    </div>
    <!-- sm -->
    <div class="col-sm-12 hidden-xs">
        <img class="img-responsive w-100" src="https://www.movilidadbogota.gov.co/web/sites/default/files/Temas/2021-07-29/banner_si_voy_en_taxi_1920_x_320_1.jpg" alt="Taxis de Bogotá - Servicio legal y de calidad las 24 horas." title="Taxis de Bogotá - Servicio legal y de calidad las 24 horas.">
    </div>
</div>
<div class="row">
    <div class="col-md-12 col-sm-12">
        ...
        <p class="pt-p">El taxi está regulado desde la reglamentación nacional y distrital de transporte público y se presta bajo la responsabilidad de empresas de transporte debidamente habilitadas y con vehículos vinculados a su parque automotor. Estos vehículos cumplen con los requisitos exigidos por las disposiciones reglamentarias para esta modalidad de servicio. <br> Adicionalmente, conductores y vehículos cumplen con los siguientes requisitos y documentación:</p>
        <ul>
...
<div class="row">
    <div class="col-12">
        ...
        <p class="pt-p">Para la liquidación de la tarifa del servicio de taxi se debe tener en cuenta el mecanismo de cobro empleado: taxímetro o plataforma tecnológica.</p>
        <h2 class="pt-h2">Tarifas para cobro por taxímetro</h2>
    ...
    <div class="col-12 align-self-center justify-content-center">
        <div class="d-flex text-center justify-content-center align-items-center">
            <div class="col-sm-10 center-block">
                ...
                <p class="m-0 p-0 f-table text-center"><small>Fuente: Decreto Distrital 013 de 2021</small></p>
            </div>
        </div>
    </div>
    <br>
                ...
                <table class="w-8 table table-responsive table-mov table-hover mb-0">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="tbl-row-sc">1</td>
                            <td class="tbl-row-sc">$908</td>
                            <td class="tbl-row-sc">$1.029</td>
                        </tr>
                        <tr>
                            <td class="tbl-row-pr">Banderazo o Arranque</td>
...
<div class="row">
    <div class="col-12">
        <p class="pt-p">En este caso, la tarifa es liquidada automáticamente por la plataforma tecnológica antes de iniciar la carrera, es mostrada en la pantalla y se calcula de acuerdo con la distancia del recorrido y la información del tráfico de la ciudad.</p>
...
<div class="row">
    <div class="col-sm-12">
        ...
        <div class="text-center ">
            <img class="pt-img" src="https://www.movilidadbogota.gov.co/web/sites/default/files/Temas/2021-07-29/que_es_la_tarjeta_de_control-.jpg" width="90%" alt="Imagen con ejemplo de la tarjeta de control" title="Tarjeta de control">
...
<div class="row">
    <div class="col-sm-12">
        <h1 class="pt-h1">Recomendaciones para los usuarios de taxi en Bogotá</h1>
        <ol>
            <li class="pt-li">Antes de ingresar al vehículo, verifique que los logos indiquen el nombre de la empresa de taxi a la cual se encuentra vinculado y la placa del vehículo.</li>
            <li class="pt-li">Los usuarios pueden validar la anterior información a través de la página web SIMUR <a class="pt-a" href="https://www.simur.gov.co/conductores-de-taxi">https://www.simur.gov.co/conductores-de-taxi</a> ingresando el número de la placa del vehículo o de la Tarjeta de Control.</li>
            ...
            <li class="pt-li">Si solicitó el taxi a través de una plataforma tecnológica tenga en cuenta que esta indicará el precio de la carrera al inicio y que este no cambia a lo largo de la misma.</li><br>
            <li class="pt-li">Actualmente la ciudad de Bogotá cuenta con 50 vehículos eléctricos los cuales tienen una tarifa del servicio igual a la del servicio básico y pueden ser solicitados en calle, call center o aplicación móvil. Estos se identifican por sus colores como se muestra a continuación</li>
        </ol>
    </div>
</div>
<div class="row">
    <div class="col-xs-8 col-xs-offset-2">
        <br>
        <img class="img-responsive w-100 pt-img" src="https://www.movilidadbogota.gov.co/web/sites/default/files/Temas/2021-07-30/taxielectricobogota.png" alt="Taxi eléctrico de Bogotá">
        <p class="m-0 p-0 f-table text-center"><small>Taxi eléctrico de Bogotá</small></p>
    </div>
</div>
<br>
<div class="row">
    <div class="col-sm 12">
        ...
        <p class="pt-p">La renovación del Pacto por la vida y el compromiso con la vida y el buen servicio se ha materializado con la entrega de 16.700 kits con gel antibacterial y tapabocas a conductoras y conductores de taxi de Bogotá desde el mes de abril de 2020, así como con más de 11.000 higienizaciones gratuitas realizadas a vehículos taxi de la ciudad.</p>
        <p class="pt-p">De otra parte, 3.264 conductoras y conductores de taxi han participado en 30 jornadas de capacitación adelantadas desde el mes de junio de 2020 en tres áreas de conocimiento y habilidades: promoción en salud, bienestar personal y familiar y calidad del servicio.</p>
    </div>
</div>
<br>
<div class="row">
