...
<div class="container-fluid seccion">
    ...
    <div class="s4">
        ...
        <div class="antidoto-txt">
            <div class="row fa">
                <div class="col-xs-12">
                    <h3>Antídoto Antisobor<span class="enc-enfasis">no</span></h3>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="s9">
        <div class="antidoto-txt">
            <div class="row fa">
                <div class="col-xs-12">
                    <h3>Política Antisobor<span class="enc-enfasis">no</span></h3>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="s13 fa">
        <div class="row">
            <div class="col-xs-12 col-sm-8">
                <ul>
                    <li>Puedes presentar tu denuncia de forma anónima.</li>
                    <li>Realiza la denuncia de manera objetiva y respetuosa.</li>
                    <li>Toda denuncia se debe fundamentar en hechos reales y comprobables.</li>
                    <li>Al suministrar la información o narrar los hechos, aporta toda la información que conozcas.</li>
                    <li>Describe lo sucedido enunciando las circunstancias de tiempo, modo y lugar: ¿qué ocurrió?, ¿cómo ocurrió?, ¿cuándo ocurrió?, ¿dónde ocurrió?, ¿quién lo hizo?, ¿con quién?No utilices estos canales para levantar falsas denuncias.</li>
...
<style type='text/css'>
    ...
    .descargable {
        ...
        border-bottom: solid 6px #de1b17;
    }

    .descargable:hover {
        border-bottom: solid 6px #f2ac33;
    }
