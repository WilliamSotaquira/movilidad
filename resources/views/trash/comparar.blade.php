<div class="content">
    ...
    <div class="row">
        <div class="col-xs-12">
            <h1 class="h1-heading text-center"><strong>Transparencia y acceso a información pública</strong></h1>
        </div>
    </div>
    <hr>
    <div class="row">
        ...
        <div class="col-xs-12">&nbsp;<p class="p-panel">La Secretaría Distrital de Movilidad pone a disposición de la ciudadanía la nueva sección de Transparencia y Acceso a la Información Pública, de acuerdo a la Ley 1712 de 2014 y a la Resolución 1519 de 2020 de MinTIC.</p>
            ...
            <div aria-multiselectable="true" class="panel-group" id="accordion" role="tablist">
                    ...
                    <div aria-labelledby="headingIMO" class="panel-collapse collapse" id="collapseIMO" role="tabpanel">
                        <div class="panel-body">
                            <ul>
                                ...
                                <li><a href="https://www.movilidadbogota.gov.co/web/funcionarios" rel="noopener noreferrer" target="_blank">Directorio que incluya el cargo</a>, direcciones de correo electrónico y teléfono del despacho de los empleados y funcionarios y las escalas salariales</li>
                                ...
                                <li><a href="https://www.movilidadbogota.gov.co/web/Plan_contra_corrupci%C3%B3n" rel="noopener noreferrer" target="_blank">Plan Anticorrupción y de Atención al Ciudadano</a></li>
                                <li><a href="#" rel="noopener noreferrer" target="_blank">Contrataciones en curso y un vínculo al sistema electrónico para la contratación pública o el que haga sus veces, a través del cual podrá accederse directamente a la información correspondiente al respectivo proceso contractual, en aquellos que se encuentren sometidas a dicho sistema, sin excepción</a></li>
                                <li><a href="https://www.movilidadbogota.gov.co/web/sites/default/files/Paginas/07-01-2021/pm04-m01-manual-de-servicio-a-la-ciudadania-v5.0-24122020.pdf" rel="noopener noreferrer" target="_blank">Servicio al público, normas, formularios y protocolos de atención</a></li>
                ...
                <div class="panel panel-default">
                    ...
                    <div aria-labelledby="headingUno" class="panel-collapse collapse" id="collapseUno" role="tabpanel">
                        <div class="panel-body">
                            ...
                            <ol>
                                <li><a href="http://www.movilidadbogota.gov.co/web/mision" rel="noopener noreferrer" target="_blank">1.1. Misión, visión, funciones y deberes</a>
                                    <ul>
                                ...
                                <li><a href="https://www.movilidadbogota.gov.co/web/organigrama" rel="noopener noreferrer" target="_blank">1.2. Estructura orgánica - Organigrama</a></li>
                                <li><a href="https://www.movilidadbogota.gov.co/web/procesos-y-procedimientos" rel="noopener noreferrer" target="_blank">1.3. Mapas y Cartas descriptivas de los procesos</a></li>
                                <li><a href="http://www.movilidadbogota.gov.co/web/puntos_de_atencion" rel="noopener noreferrer" target="_blank">1.4. Directorio Institucional</a></li>
                                <li><a href="https://www.movilidadbogota.gov.co/web/funcionarios" rel="noopener noreferrer" target="_blank">1.5. Directorio de servidores públicos, empleados o contratistas</a></li>
                                <li><a href="https://www.movilidadbogota.gov.co/web/directorio_entidades" rel="noopener noreferrer" target="_blank">1.6. Directorio de entidades</a></li>
                                <li><a href="https://www.movilidadbogota.gov.co/web/agremiaciones" rel="noopener noreferrer" target="_blank">1.7. Directorio de agremiaciones o asociaciones en las que participe</a></li>
                                <li><a href="#" rel="noopener noreferrer" target="_blank">1.8. Servicio al público, normas, formularios y protocolos de atención</a>
                                    <ul>
                                        <li><a href="https://www.movilidadbogota.gov.co/web/manual_de_servicio_al_ciudadano" rel="noopener noreferrer" target="_blank">Manual de Servicio al Ciudadano</a></li>
                                ...
                                <li><a href="https://www.movilidadbogota.gov.co/web/procesos-y-procedimientos" rel="noopener noreferrer" target="_blank">1.9. Procedimientos que se siguen para tomar decisiones en las diferentes áreas</a></li>
                                <li><a href="https://www.movilidadbogota.gov.co/web/govi-sdqs/crear" rel="noopener noreferrer" target="_blank">1.10. Mecanismo de presentación directa de solicitudes, quejas y reclamos a disposición del público en relación con acciones u omisiones del sujeto obligado</a></li>
                                <li><a href="https://www.movilidadbogota.gov.co/web/calendario_de_actividades" rel="noopener noreferrer" target="_blank">1.11. Calendario de actividades y eventos</a></li>
                                <li><a href="https://www.movilidadbogota.gov.co/web/historico_noticias" rel="noopener noreferrer" target="_blank">1.12. Información sobre decisiones que puede afectar al público</a></li>
                                <li><a href="https://www.movilidadbogota.gov.co/web/mecanismos-control-supervision" rel="noopener noreferrer" target="_blank">1.13. Entes y autoridades que lo vigilan</a></li>
                                <li><a href="#" rel="noopener noreferrer" target="_blank">1.14. Publicación de hojas de vida</a></li><!-- <li><a href="#" target="_blank" rel="noopener noreferrer">1.15. Aporte público al empleo</a></li> -->
                            </ol>
                        </div>
                    </div>
                </div><!-- /#collapseUno -->
                ...
                <div class="panel panel-default">
                    ...
                    <div aria-labelledby="headingDos" class="panel-collapse collapse" id="collapseDos" role="tabpanel">
                        <div class="panel-body">
                            <p class="p-panel">Esta sección encontrará el acceso a las normas correspondientes al sujeto obligado.</p><!-- collapseDosUno -->
                            <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="panel panel-default">
                                            <div class="panel-heading ph-3" id="headingDosUnoUno" role="tab">
                                                <h4 class="panel-title"><a aria-controls="collapseDosUnoUno" aria-expanded="true" data-parent="#headingDosUno" data-toggle="collapse" href="#collapseDosUnoUno" role="button">2.1.1 Leyes </a></h4>
                                            </div>
                                            <div aria-labelledby="headingDosUnoUno" class="panel-collapse collapse" id="collapseDosUnoUno" role="tabpanel">
                                                <div class="panel-body">
                                                    <ul>
                                                        <li><a href="https://www.movilidadbogota.gov.co/web/normatividad" rel="noopener noreferrer" target="_blank">Leyes</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div><!-- /#collapseDosUnoUno -->
                                        <!-- collapseDosUnoDos -->
                                        <div class="panel panel-default">
                                            <div class="panel-heading ph-3" id="headingDosUnoUno" role="tab">
                                                <h4 class="panel-title"><a aria-controls="collapseDosUnoDos" aria-expanded="true" data-parent="#headingDosUno" data-toggle="collapse" href="#collapseDosUnoDos" role="button">2.1.2 Decreto Único Reglamentario </a></h4>
                                            </div>
                                            <div aria-labelledby="headingDosUnoUno" class="panel-collapse collapse" id="collapseDosUnoDos" role="tabpanel">
                                                <div class="panel-body">
                                                    <ul>
                                                        <li><a href="#" rel="noopener noreferrer" target="_blank">Decreto Único Reglamentario</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div><!-- /#collapseDosUnoDos -->
                                        <!-- collapseDosUnoTres -->
                                        <div class="panel panel-default">
                                            <div class="panel-heading ph-3" id="headingDosUnoUno" role="tab">
                                                <h4 class="panel-title"><a aria-controls="collapseDosUnoTres" aria-expanded="true" data-parent="#headingDosUno" data-toggle="collapse" href="#collapseDosUnoTres" role="button">2.1.3 Normativa aplicable </a></h4>
                                            </div>
                                            <div aria-labelledby="headingDosUnoUno" class="panel-collapse collapse" id="collapseDosUnoTres" role="tabpanel">
                                                <div class="panel-body">
                                                    <ul>
                                                        <li><a href="http://www.movilidadbogota.gov.co/web/normatividad_aplicable" rel="noopener noreferrer" target="_blank">Normativa aplicable</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div><!-- /#collapseDosUnoTres -->
                                        <!-- collapseDosUnoCuatro -->
                                        <div class="panel panel-default">
                                            <div class="panel-heading ph-3" id="headingDosUnoUno" role="tab">
                                                <h4 class="panel-title"><a aria-controls="collapseDosUnoCuatro" aria-expanded="true" data-parent="#headingDosUno" data-toggle="collapse" href="#collapseDosUnoCuatro" role="button">2.1.4 Vínculo al Diario o Gaceta Oficial. </a></h4>
                                            </div>
                                            <div aria-labelledby="headingDosUnoUno" class="panel-collapse collapse" id="collapseDosUnoCuatro" role="tabpanel">
                                                <div class="panel-body">
                                                    <ul>
                                                        <li><a href="" rel="noopener noreferrer" target="_blank">Vínculo al Diario o Gaceta Oficial</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div><!-- /#collapseDosUnoCuatro -->
                                        <!-- collapseDosUnoCinco -->
                                        <div class="panel panel-default">
                                            <div class="panel-heading ph-3" id="headingDosUnoUno" role="tab">
                                                <h4 class="panel-title"><a aria-controls="collapseDosUnoCinco" aria-expanded="true" data-parent="#headingDosUno" data-toggle="collapse" href="#collapseDosUnoCinco" role="button">2.1.5. Políticas, lineamientos y manuales. </a></h4>
                                            </div>
                                            <div aria-labelledby="headingDosUnoUno" class="panel-collapse collapse" id="collapseDosUnoCinco" role="tabpanel">
                                                <div class="panel-body">
                                                    <ul>
                                        ...
                                        </div><!-- /#collapseDosUnoCinco -->
                                        <!-- collapseDosUnoSeis -->
                                        <div class="panel panel-default">
                                            <div class="panel-heading ph-3" id="headingUno" role="tab">
                                                <h4 class="panel-title"><a aria-controls="collapseDosUnoSeis" aria-expanded="true" data-parent="#headingDosUno" data-toggle="collapse" href="#collapseDosUnoSeis" role="button">2.1.6 Agenda Regulatoria </a></h4>
                                            </div>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div aria-labelledby="headingDosDos" class="panel-collapse collapse" id="collapseDosDos" role="tabpanel">
                                    <div class="panel-body">
                                        <ol>
                                            <li><a href="#" rel="noopener noreferrer" target="_blank">2.2.1 Sistema Único de Información Normativa – SUIN</a></li>
                                            <li><a href="#" rel="noopener noreferrer" target="_blank">2.2.2 Sistema de búsquedas de normas, propio de la entidad.</a></li>
                                        </ol>
                                    </div>
                                </div>
                            </div><!-- /#collapseDosDos -->
                            ...
                            <div class="panel panel-default">
                                ...
                                <div aria-labelledby="headingDosTres" class="panel-collapse collapse" id="collapseDosTres" role="tabpanel">
                                    <div class="panel-body">
                                        <ol>
                                            <li><a href="https://www.movilidadbogota.gov.co/web/normatividad" rel="noopener noreferrer" target="_blank">2.3.1 Proyectos normativos</a></li>
                                            <li><a href="https://www.movilidadbogota.gov.co/web/normatividad" rel="noopener noreferrer" target="_blank">2.3.2 Comentarios y documento de respuesta a comentarios.</a></li>
                                        </ol>
                                    </div>
                                </div>
                            </div><!-- /#collapseDosTres -->
                ...
                <div class="panel panel-default">
                    ...
                    <div aria-labelledby="headingTres" class="panel-collapse collapse" id="collapseTres" role="tabpanel">
                        <div class="panel-body">
                            ...
                            <ol>
                                <li><a href="http://www.movilidadbogota.gov.co/web/plan_anual_de_adquisiciones" rel="noopener noreferrer" target="_blank">3.1 Plan Anual de Adquisiciones</a></li>
                                <li><a href="https://www.colombiacompra.gov.co/" rel="noopener noreferrer" target="_blank">3.2 Publicación de la información contractual</a></li>
                                <li><a href="https://www.movilidadbogota.gov.co/web/procesos_de_contratacion" rel="noopener noreferrer" target="_blank">3.3 Publicación de la ejecución de los contratos</a></li>
                                <li><a href="https://www.movilidadbogota.gov.co/web/manuales_de_contratacion" rel="noopener noreferrer" target="_blank">3.4 Manual de contratación, adquisición y/o compras</a></li>
                                <li><a href="#" rel="noopener noreferrer" target="_blank">3.5 Formatos o modelos de contratos o pliegos tipo</a></li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /#collapseTres -->
                ...
                <div class="panel panel-default">
                    ...
                    <div aria-labelledby="headingCuatro" class="panel-collapse collapse" id="collapseCuatro" role="tabpanel">
                        <div class="panel-body">
                            ...
                            <ol>
                                <li><a rel="noopener noreferrer" target="_blank">4.1 Presupuesto general de ingresos, gastos e inversión</a>
                                    <ul>
                                ...
                                <li><a href="https://www.movilidadbogota.gov.co/web/ejecucion_presupuestal" rel="noopener noreferrer" target="_blank">4.2 Ejecución presupuestal</a></li>
                                <li><a href="#" rel="noopener noreferrer" target="_blank">4.3 Plan de Acción</a>
                                    <ul>
                                        <li><a href="https://www.movilidadbogota.gov.co/web/planes_institucionales_y_estrategicos_decreto_61218" rel="noopener noreferrer" target="_blank">Planes Institucionales y Estratégicos (Decreto 612/18)</a></li>
                                ...
                                <li><a href="https://www.movilidadbogota.gov.co/web/programas_y_proyectos" rel="noopener noreferrer" target="_blank">4.4 Proyectos de Inversión</a></li>
                                <li><a href="https://www.movilidadbogota.gov.co/web/informes_de_empalme" rel="noopener noreferrer" target="_blank">4.5 Informes de empalme</a></li>
                                ...
                                <li><a href="#" rel="noopener noreferrer" target="_blank">4.8 Informes de la Oficina de Control Interno</a>
                                    <ul>
                                ...
                                <li><a href="https://www.movilidadbogota.gov.co/web/defensa-judicial" rel="noopener noreferrer" target="_blank">4.9 Informe sobre Defensa Pública y Prevención del Daño Antijurídico</a></li>
                                <li><a href="https://www.movilidadbogota.gov.co/web/informacion_pqrs" rel="noopener noreferrer" target="_blank">4.10 Informes mensuales sobre acceso a información, quejas y reclamos</a></li>
                                <li><a href="https://www.movilidadbogota.gov.co/web/gestion_de_riesgos" rel="noopener noreferrer" target="_blank">4.11. Gestión de los Riesgos</a></li>
                                <li><a href="https://www.movilidadbogota.gov.co/web/analisis_del_contexto" rel="noopener noreferrer" target="_blank">4.12. Análisis del Contexto</a></li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /#collapseCuatro -->
                ...
                <div class="panel panel-default">
                    ...
                    <div aria-labelledby="headingCinco" class="panel-collapse collapse" id="collapseCinco" role="tabpanel">
                        <div class="panel-body">
                            ...
                            <ol>
                                <li><a href="https://www.movilidadbogota.gov.co/web/tramites_y_servicios_virtuales" rel="noopener noreferrer" target="_blank">5.1 Trámites y Servicios en Linea</a></li>
                                <li><a href="https://www.movilidadbogota.gov.co/web/tramites_y_servicios_virtuales" rel="noopener noreferrer" target="_blank">5.2 Portafolio de Trámites y Servicios</a></li>
                                <li><a href="https://www.gov.co/ficha-tramites-y-servicios/" rel="noopener noreferrer" target="_blank">5.3 Trámites y Servicios Portal GOV.CO</a></li>
                                <li><a href="https://www.funcionpublica.gov.co/web/suit" rel="noopener noreferrer" target="_blank">5.4 Trámites y Servicios Portal SUIT</a></li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /#collapseCinco -->
                ...
                <div class="panel panel-default">
                    ...
                    <div aria-labelledby="headingSiete" class="panel-collapse collapse" id="collapseSiete" role="tabpanel">
                        <div class="panel-body">
                            ...
                            <ol>
                                <li><a href="https://www.movilidadbogota.gov.co/web/informacion-clasificada-reservada" rel="noopener noreferrer" target="_blank">7.1 Instrumentos de gestión de la información</a>
                                    <ol>
                                        <li><a href="https://datosabiertos.bogota.gov.co/dataset/activos-de-informacion-secretaria-de-movilidad" rel="noopener noreferrer" target="_blank">7.1.1. Registros De Activos De Información</a></li>
                                        <li><a href="https://www.movilidadbogota.gov.co/web/sites/default/files/Paginas/27-11-2020/pa01-pr05-f03_cuadro_de_caracterizacion_documental_indice_de_informacion.xlsx" rel="noopener noreferrer" target="_blank">7.1.2. Índice De Información Clasificada Y Reservada</a></li>
                                        <li><a href="https://www.movilidadbogota.gov.co/web/esquema-publicacion-informacion" rel="noopener noreferrer" target="_blank">7.1.3. Esquema De Publicación De La Información</a></li>
                                        <li><a href="https://www.movilidadbogota.gov.co/web/informacion-clasificada-reservada" rel="noopener noreferrer" target="_blank">7.1.4. Tipos De Datos - Información Clasificada o Reservada</a></li>
                                        <li><a href="https://www.movilidadbogota.gov.co/web/programa-gestion-documental" rel="noopener noreferrer" target="_blank">7.1.5. Programa De Gestión Documental</a></li>
                                        <li><a href="https://www.movilidadbogota.gov.co/web/tablas-retencion-documental" rel="noopener noreferrer" target="_blank">7.1.6. Tablas De Retención Documental</a></li>
                                    </ol>
                                    <ul>
                                ...
                                <li><a href="https://www.movilidadbogota.gov.co/web/node/1654" rel="noopener noreferrer" target="_blank">7.2 Sección de Datos Abiertos</a>
                                    <ol>
                                        <li><a href="https://www.simur.gov.co/datos-abiertos" rel="noopener noreferrer" target="_blank">7.2.1 Datos Abiertos SIMUR</a></li>
                                        <li><a href="https://datosabiertos.bogota.gov.co/dataset?organization=sdm" rel="noopener noreferrer" target="_blank">7.2.2 Datos Abiertos GOV.co </a></li>
                                    </ol>
                                </li>
                            </ol>
                        </div>
                ...
                <div class="panel panel-default">
                    ...
                    <div aria-labelledby="headingOcho" class="panel-collapse collapse" id="collapseOcho" role="tabpanel">
                        <div class="panel-body">
                            ...
                            <ol>
                                <li><a href="#" rel="noopener noreferrer" target="_blank">8.1. Información para niños, niñas y adolescentes</a>
                                    <ol>
                                        <li><a href="https://www.movilidadbogota.gov.co/web/portal-infantil" rel="noopener noreferrer" target="_blank">8.1.1. Portal Infantil</a></li>
                                        <li><a href="https://www.movilidadbogota.gov.co/web/sites/default/files/Paginas/02-07-2021/ninos_ninas_y_adolescentes_junio_2021_web.xlsx" rel="noopener noreferrer" target="_blank">8.1.2. Información de interés para niñas, niños y adolescentes</a></li>
                                    </ol>
                                </li>
                                <li><a href="https://www.movilidadbogota.gov.co/web/mujer" rel="noopener noreferrer" target="_blank">8.2. Información para Mujeres</a></li>
                                <li><a href="https://www.movilidadbogota.gov.co/web/informacion-poblacion-vulnerable">8.3. Información para población vulnerable</a></li>
                ...
                <li><a href="#" target="_blank" rel="noopener noreferrer">8.4 Informes de los indicadores de grupos étnicos de paz</a></li> -->
                                <li><a href="https://www.movilidadbogota.gov.co/web/mujer" rel="noopener noreferrer" target="_blank">8.4. Otros Idiomas:</a>
                                    <ol>
                                        <li><a href="https://www.movilidadbogota.gov.co/web/sites/default/files/Paginas/27-11-2020/idioma_kichwa.pdf" rel="noopener noreferrer" target="_blank">8.4.1. Idioma Kichwa</a></li>
                                        <li><a href="https://www.movilidadbogota.gov.co/web/sites/default/files/Paginas/02-12-2020/idioma-muisca.pdf" rel="noopener noreferrer" target="_blank">8.4.2. Idioma Muisca</a></li>
                                    </ol>
                                </li>
                            </ol>
                        </div>
                ...
                <div class="panel panel-default">
                    ...
                    <div aria-labelledby="headingNueve" class="panel-collapse collapse" id="collapseNueve" role="tabpanel">
                        <div class="panel-body">
                            ...
                            <ol>
                                <li><a rel="noopener noreferrer" target="_blank">9.1 Estudios, investigaciones y otras publicaciones</a>
                                    <ul>
                                ...
                                <li><a href="#" rel="noopener noreferrer" target="_blank">9.2 Convocatorias</a></li>
                                <li><a href="https://www.movilidadbogota.gov.co/web/modelo_integrado_de_planeacion_y_gestion" rel="noopener noreferrer" target="_blank">9.3 Modelo Integrado de Planeacion y Gestión (MIPG) </a></li>
                                <li><a rel="noopener noreferrer" target="_blank">9.4 Gestión del Talento Humano</a>
                                    <ul>
                                ...
                                <li><a href="https://www.movilidadbogota.gov.co/web/canal_anticorrupcion" rel="noopener noreferrer" target="_blank">9.5 Denuncias por actos de corrupción</a></li>
                                <li><a href="https://www.movilidadbogota.gov.co/web/agenda_directivos" rel="noopener noreferrer" target="_blank">9.6 Agenda Directivos</a></li>
