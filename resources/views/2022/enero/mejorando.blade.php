...
<style type='text/css'>
    ...
    .s1 .p-encabezado {
        ...
        border-image: -webkit-linear-gradient(left, #c91719, #f4b300) 1 10;
    ...
    .s2 .img-descripcion {
        background: rgb(201, 23, 25);
        background: linear-gradient(45deg, rgba(201, 23, 25, 1) 0%, rgba(244, 179, 0, 1) 80%);
        /* background-color: #f4b300; */
                ...
                <div class="encabezado">
                    <div class="img-encabezado">
                        <div class='logo-encabezado'>
                            <img class='img-responsive w-100 ' src='https://www.movilidadbogota.gov.co/web/sites/default/files/Paginas/08-01-2022/03-seccion-1_logo_sin_fondo_op_1.png' alt='Logo Bogotá esta mejorando' title='Logo Bogotá esta mejorando'>
                        </div>
                        <div class="p-encabezado">
                            <h3>¿Por qué Bogotá está Mejorando?</h3>
                            ...
                            <p>Así nace, <strong>Bogotá está mejorando con nuevas obras de infraestructura y con movilidad sostenible</strong> como respuesta a la fase de megaobras en la que entró la ciudad, y que le va a permitir ponerse al día después de décadas de estancamiento en materia de infraestructura vial.</p>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="boxbtnbem zoom">
                            <a href="#infraestructura" aria-controls="infraestructura" role="tab" data-toggle="tab">
                                ...
                                <div class="txt-btn-bem">
                                    <div>
                                        <h3>
                                            Con estas obras Bogotá está mejorando
                                        </h3>
                                    </div>
                                </div>
                            </a>
                        ...
                        <div class="boxbtnbem zoom">
                            <a href="#clips" aria-controls="clips" role="tab" data-toggle="tab">
                                ...
                                <div class="txt-btn-bem">
                                    <div>
                                        <h3>
                                            Bogotá está mejorando en video
                                        </h3>
                                    </div>
                                </div>
                            </a>
                            ...
                            <div class='row'>
                                <div class='col-xs-12 visible-xs'>
                                    <div class="descripcion">
                                        ...
                                        <p>La Unidad de Mantenimiento Vial (UMV), como encargada de conservar la malla vial local, intermedia y rural, así como la cicloinfraestructura, en compañía del Instituto de Desarrollo Urbano (IDU) avanzan en el Plan Tapahuecos dentro de la estrategia de Bogotá está Mejorando que incluye reparar 56.000 huecos y hacer mantenimiento a 18,7 km/carril (equivalentes a 117 calles de doble carril).</p>
                            ...
                            <div class='row'>
                                <div class='col-xs-12'>
                                    ...
                                    <div class="descripcion">
                                        ...
                                        <p>Finalmente haga una reflexión interior y piense “no voy solo en la vía” si logra tener prudencia, paciencia y pilera a la hora de andar por Bogotá haciendo uso de las normas básicas de tránsito, la movilidad mejorará notablemente, esto es un aporte suyo al hecho de que <strong>Bogotá está mejorando</strong>.</p>
                            ...
                            <div class='row'>
                                ...
                                <div class='col-xs-12 col-sm-12'>
                                    <div class="introduccion text-center">
                                        <div>
                                            <p>Encuentra toda la actualidad de Bogotá Está Mejorando en está sección.</p>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="descripcion-tito">
                                        <div>
                                            ...
                                            <div class="introduccion-2">
                                                ...
                                                <p>Bienvenidos, este es un espacio para que conozcas con los ojos de <strong>Tito Calle</strong>, cómo Bogotá está mejorando.</p>
