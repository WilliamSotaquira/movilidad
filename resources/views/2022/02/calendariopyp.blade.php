		...
		<div class="row">
			<div class="col-xs-12 col-sm-8 col-sm-offset-2">
				<p style="text-align: center;">
                    <a class="btn btn-primary btn-lg btn-block" href="https://www.movilidadbogota.gov.co/web/sites/default/files/Temas/2024-10-02/calendario_pico_y_placa_2024-_octubre.pdf" role="button" target="_blank">Pico y Placa octubre de 2024</a>
                </p>
			</div>
		</div>
