...
<div class='container-fluid resultados_bc no-gutter'>
    ...
    <div class="box-tabs">
        <ul class="nav nav-tabs nav-justified">
            <li><a data-toggle="tab" href="#reporte1">Reporte de indicadores # 1 - Marzo 2021 </a></li>
            <li><a data-toggle="tab" href="#reporte2">Reporte de indicadores # 2 (final) - Julio 2021</a></li>
        </ul>

        <div class="tab-content">

            <div id="reporte1" class="tab-pane fade in active">
                <div class="rpte1">

                    <div class="box-bca">
                        <img class='img-responsive w-100 img1' src='https://www.movilidadbogota.gov.co/web/sites/default/files/Paginas/24-05-2021/bc-mn-recurso_21.png' alt='imagen reporte de indicadores 11/20 - 03/21' title='imagen reporte de indicadores 11/20 - 03/21'>
                    </div>
                    <div class="box-bca">
                        <a href="https://www.movilidadbogota.gov.co/web/sites/default/files/Paginas/25-05-2021/resultados_bicicarga_v2.pdf">
            ...
            <div id="reporte2" class="tab-pane fade">
                <div class="box-rpte2">
                    <a class="btn-bc" href="https://www.movilidadbogota.gov.co/web/sites/default/files/Paginas/10-03-2022/reporte_final_indicadores_bicicarga.pdf">
                        Reporte final Indicadores BiciCarga
                    </a>
