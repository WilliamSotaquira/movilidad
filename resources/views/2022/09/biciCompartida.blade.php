        ...
        <div class="box-contador">
            ...
            <div class="box-botones">
                <a data-toggle="tab" href="#bici1">
                    <div class="boton zoom">
                        <h3 class="wow animate__animated animate__bounceInUp animate__delay-1s animate__slow">1500</h3>
                ...
                <a data-toggle="tab" href="#bici4">
                    <div class="boton zoom">
                        <h3 class="wow animate__animated animate__bounceInUp animate__delay-1s animate__slow">150</h3>
                ...
                <a data-toggle="tab" href="#bici5">
                    <div class="boton zoom">
                        <h3 class="wow animate__animated animate__bounceInUp animate__delay-1s animate__slow">300</h3>
            ...
            <style>
                ...
                .box-wrp .box-botones .boton {
                    ...
                    align-items: center;
                    border-radius: 16px;
                    border: solid 2px rgba(147, 195, 221, 1);
                }
            ...
            <div class="tab-content">
                ...
                <div id="bici1" class="tab-pane fade in active">
                    ...
                    <div class='imagen-bici'>
                        <img class='img-responsive w-100' src='https://tembici.com.co/wp-content/uploads/2022/07/GIF-Bike-fit_sem-numero.gif-bici' alt='' title=''>
                    </div>
                </div>
