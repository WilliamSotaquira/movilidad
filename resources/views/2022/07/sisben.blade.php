                    ...
                    <div role="tabpanel" class="tab-pane active" id="inicio">
                        <div class="box-inicio">
                            ...
                            <div class="seccion3">
                                ...
                                <div class="texto-seccion2">
                                    ...
                                    <div class="parrafo">
                                        <p>Si cuentas con clasificación Sisbén IV y a qué grupo perteneces, en la página del Departamento Nacional de Planeación</p>
                                    </div>
                                    <div>
                            ...
                            <div class="seccion4" id="seccion4">
                                ...
                                <div class="card-sisben zoom tarjeta">
                                    ...
                                    <div class="texto">
                                        ...
                                        <p>Si no tienes la tarjeta Tu Llave personalizada, solicítala para acceder con ella al incentivo en los pasajes del SITP</p>
                                    </div>
                                </div>
                                <style>
                                    .seccion4 {
                            ...
                            <div class="seccion5">
                                ...
                                <div class="texto-solicita">
                                    ...
                                    <div class="parrafo">
                                        <p>Si no estás registrado, debes solicitar a la Secretaría Distrital de Planeación la aplicación de la encuesta Sisbén IV en la Red CADE o en línea</p>
                                    </div>
                                    <div>
                        ...
                        <div class="seccion6" id="seccion6">
                            <div class="texto-accede">
                                ...
                                <div class="parrafo">
                                    <p>Una vez haya sido asignado el subsidio a tu grupo correspondiente del Sisbén IV mediante resolución de la Secretaría Distrital de Movilidad, podrás disfrutar del descuento en tus pasajes usando tu tarjeta personalizada Tu Llave. Si aún no la tienes, deberás esperar un mes después de la resolución para solicitarla y acceder al beneficio.</p>
                                </div>
                                <div>
                        ...
                        <div class="seccion7">
                            ...
                            <div class="numeros">
                                ...
                                <div class="numero numero2">
                                    ...
                                    <h3>SOLICITA</h3>
                                    <p>Ser beneficiario del subsidio a los grupos priorizados del Sisbén IV, y anular el subsidio de adulto mayor.</p>
                                </div>
