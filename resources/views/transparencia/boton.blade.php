...
<!-- Set transparencia -->
<div class="set-wrapper transparencia"><!-- ----- ----- ----- ----- ----- ----- ----- -----  Fuente Montserrat -----  ----- ----- ----- ----- ----- ----- ----- ----- ------ --></div>
...
<div class="container-fluid seccion">
        ...
        <div class="row">
            <div class="col-xs-10 col-xs-offset-1">
                <div class="embed-responsive embed-responsive-16by9 bs">
                    <video controls="" height="315" src="https://www.movilidadbogota.gov.co/web/sites/default/files/Paginas/05-08-2021/video_menu_transparencia.mp4" type="video/mp4" width="560">&nbsp;</video>
                </div>
            </div>
        </div>
        <style type="text/css">
    ...
    <div class="s1">
        ...
        <div class="row">
            <div class="col-xs-12">
                <p>La Secretaría Distrital de Movilidad pone a disposición de la ciudadanía la nueva sección de Transparencia y Acceso a la Información Pública, de acuerdo las directrices de la Ley 1712 de 2014 y la Resolución 1519 de 2020 de MinTIC.</p>

                <p>En esta sección encontrará información de interés de la Secretaría Distrital de Movilidad, los mecanismos de contacto, la estructura orgánica, talento humano, normatividad aplicable, planeación, mecanismos de control, contratación, trámites y servicios y gestión de la información, así como información adicional que la entidad considere relevante para los grupos de valor y partes interesadas.</p>
            </div>
        </div>
    ...
    <div class="s2">
                        ...
                        <div aria-labelledby="headingIMO" class="panel-collapse collapse" id="collapseIMO" role="tabpanel">
                            <div class="panel-body">
                                <ul>
                                    ...
                                    <li><a href="https://www.movilidadbogota.gov.co/web/presupuesto_de_gastos" rel="noopener noreferrer" target="_blank">Presupuesto general,</a> <a href="https://www.movilidadbogota.gov.co/web/ejecucion_presupuestal" rel="noopener noreferrer" target="_blank"> ejecución presupuestal histórica anual</a> <a href="https://www.movilidadbogota.gov.co/web/ejecucion_presupuestal#collapse3" rel="noopener noreferrer" target="_blank"> y </a><a href="https://www.movilidadbogota.gov.co/web/plan_del_gasto_publico" rel="noopener noreferrer" target="_blank">planes de gasto público</a> para cada año fiscal</li>
                                    ...
                                    <li><a href="https://www.movilidadbogota.gov.co/web/Plan_contra_corrupcion" rel="noopener noreferrer" target="_blank">Plan Anticorrupción y de Atención a la Ciudadanía</a></li>
                                    ...
                                    <li><a href="https://www.movilidadbogota.gov.co/web/registro-publicaciones" rel="noopener noreferrer" target="_blank">Registro de publicaciones que contenga los documentos publicados de conformidad con la presente ley y automáticamente disponibles,</a> <a href="https://www.movilidadbogota.gov.co/web/indice_de_informacion_clasificada_y_reservada" rel="noopener noreferrer" target="_blank"> así como un Registro de Activos de Información</a></li>
                                    ...
                                    <li><a href="https://www.movilidadbogota.gov.co/web/registros_de_activos_de_informacion" rel="noopener noreferrer" target="_blank">Registro de Activos de Información</a></li>
                                    <li><a href="https://www.movilidadbogota.gov.co/web/indice_de_informacion_clasificada_y_reservada" rel="noopener noreferrer" target="_blank">Índice de Información Clasificada y Reservada</a></li>
                                ...
                                <ol>
                                    ...
                                    <li><span class="enfasis_num">1.8.</span>Servicio al público, normas, formularios y protocolos de atención
                                        <ul>
                                            ...
                                            <li><a href="https://www.movilidadbogota.gov.co/web/carta_de_compromiso_con_la_ciudadania" rel="noopener noreferrer" target="_blank">Derechos y Deberes a la Ciudadanía</a></li>
                                    ...
                                    <li><a href="https://www.movilidadbogota.gov.co/radicacionwebsdm/formulario.php" rel="noopener noreferrer" target="_blank"><span class="enfasis_num">1.10.</span>Mecanismo de presentación directa de solicitudes, quejas y reclamos a disposición del público en relación con acciones u omisiones del sujeto obligado</a>
                                        <div class="box-blockquote">
                                            <blockquote>
                                                <p>A partir del 1 de junio, la Secretaría de Movilidad, pone a disposición de la ciudadanía este <a href="https://www.movilidadbogota.gov.co/radicacionwebsdm/formulario.php">formulario web</a> como único canal, para radicar ante la Entidad: peticiones, quejas, reclamos, solicitudes, comunicaciones, facturas e informes, entre otros. Los entes de control o entidades públicas del orden distrital o nacional, pueden radicar sus comunicaciones a través de <a href="mailto:radicacionentidades@movilidadbogota.gov.co">radicacionentidades@movilidadbogota.gov.co.</a> Nuestro horario de atención es de lunes a viernes, de 7:00 a.m. a 5:00 p.m. y sábados, de 8:00 a.m. a 12:00 m. Tenga presente que las comunicaciones ingresadas después del horario informado, serán radicadas a partir del siguiente día hábil. Recuerde que el correo de <i>contactociudadano@movilidadbogota.gov.co</i> quedó deshabilitado. Todos estos trámites son gratis y sin intermediarios.</p>
                                            </blockquote>
                                        </div>
                                    </li>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div aria-labelledby="headingDos" class="panel-collapse collapse" id="collapseDos" role="tabpanel">
                            <div class="panel-body">
                                ...
                                <div aria-multiselectable="true" class="panel-group" id="accordion_dos" role="tablist "><!-- collapseDosUno -->
                                    <div class="panel panel-default">
                                            ...
                                            <div class="panel-body">
                                                <ol>
                                                    ...
                                                    <li><span class="enfasis_num">2.1.5.</span>Políticas, lineamientos y manuales.
                                                        <ul><!--<li><a href="https://www.movilidadbogota.gov.co/web/politicas_lineamientos_y_manuales" rel="noopener noreferrer" target="_blank">Políticas, lineamientos y manuales</a></li>Enlace Obsoleto-->
                                                            ...
                                                            <li><a href="https://www.movilidadbogota.gov.co/web/procesos-y-procedimientos" rel="noopener noreferrer" target="_blank">Manuales</a></li>
                                                            <li><a href="https://www.movilidadbogota.gov.co/web/procesos-y-procedimientos" rel="noopener noreferrer" target="_blank">Protocolos</a></li>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div aria-labelledby="headingCuatro" class="panel-collapse collapse" id="collapseCuatro" role="tabpanel">
                            <div class="panel-body">
                                ...
                                <ol>
                                    <li><a href="https://www.movilidadbogota.gov.co/web/presupuesto_general_de_ingresos_gastos_e_inversion" rel="noopener noreferrer" target="_blank"><span class="enfasis_num">4.1.</span>Presupuesto general de ingresos, gastos e inversión</a></li>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div aria-labelledby="headingCinco" class="panel-collapse collapse" id="collapseCinco" role="tabpanel">
                            <div class="panel-body">
                                ...
                                <ol>
                                    <li><a href="https://www.movilidadbogota.gov.co/web/tramites_y_servicios" rel="noopener noreferrer" target="_blank"><span class="enfasis_num">5.1.</span>Trámites y Servicios</a></li>
                        ...
                        <div aria-labelledby="headingSeis" class="panel-collapse collapse" id="collapseSeis" role="tabpanel">
                            <div class="panel-body">
                                ...
                                <ol>
                                    ...
                                    <li><a href="https://www.movilidadbogota.gov.co/web/presupuesto_de_gastos"><span class="enfasis_num">6.2.</span>Planeación y/o presupuesto participativo</a></li>
                                    <li><a><span class="enfasis_num">6.3.</span>Participación y consulta ciudadana de proyectos, normas, políticas o programas</a>
                                        <ol>
                                            <li><a href="https://www.movilidadbogota.gov.co/web/planes_institucionales_y_estrategicos"><span class="enfasis_num">6.3.1.</span> Participación en planes</a></li>
                                            <li><a href="https://www.movilidadbogota.gov.co/web/proyectos_de_acuerdo_decreto"><span class="enfasis_num">6.3.2.</span> Participación normativa</a></li>
                                        </ol>
                                    </li>
                                    ...
                                    <li><a href="https://www.movilidadbogota.gov.co/web/informes-rendicion-cuentas" rel="noopener noreferrer" target="_blank"><span class="enfasis_num">6.5.</span>Rendición de Cuentas</a></li>
                                    ...
                                    <li><a href="https://www.movilidadbogota.gov.co/web/control_social" rel="noopener noreferrer" target="_blank"><span class="enfasis_num">6.7.</span>Control social</a></li>
                                </ol>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="panel-body">
                                ...
                                <ol>
                                    <li><span class="enfasis_num">7.1.</span>Instrumentos de gestión de la información
                                        ...
                                        <ol>
                                            <li><a href="https://www.movilidadbogota.gov.co/web/registros_de_activos_de_informacion" rel="noopener noreferrer" target="_blank"><span class="enfasis_num">7.1.1.</span>Registros de activos de información</a></li>
                                            <li><a href="https://www.movilidadbogota.gov.co/web/indice_de_informacion_clasificada_y_reservada" rel="noopener noreferrer" target="_blank"><span class="enfasis_num">7.1.2.</span>Índice de información clasificada y reservada</a></li>
                                            ...
                                            <li><a href="https://www.movilidadbogota.gov.co/web/tipos_de_datos_o_informacion_clasificada_o_reservada" rel="noopener noreferrer" target="_blank"><span class="enfasis_num">7.1.4.</span>Tipos de datos - Información clasificada o reservada</a></li>
                                            ...
                                            <li><a href="https://www.movilidadbogota.gov.co/web/costos_de_reproduccion_de_informacion_publica" rel="noopener noreferrer" target="_blank"><span class="enfasis_num">7.1.7.</span>Costos de reproducción de información pública</a></li>
                                        </ol>
                                    </li>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div aria-labelledby="headingOcho" class="panel-collapse collapse" id="collapseOcho" role="tabpanel">
                            <div class="panel-body">
                                ...
                                <ol>
                                    <li><a href="https://www.movilidadbogota.gov.co/web/informacion_para_ninos_ninas_y_adolescentes"><span class="enfasis_num">8.1.</span>Información para niños, niñas y adolescentes</a></li>
                                    <li><a href="https://www.movilidadbogota.gov.co/web/informacion_para_mujeres"><span class="enfasis_num">8.2.</span>Información para mujeres</a></li>
                                    <li><a href="https://www.movilidadbogota.gov.co/web/informacion_para_sector_social_lgtbi" rel="noopener noreferrer" target="_blank"><span class="enfasis_num">8.3.</span>Información para el Sector Social LGTBI</a></li>
                                    <li><a href="https://www.movilidadbogota.gov.co/web/informacion_para_grupos_etnicos" rel="noopener noreferrer" target="_blank"><span class="enfasis_num">8.4.</span>Información para Grupos Étnicos</a></li>
                                    <li><a href="https://www.movilidadbogota.gov.co/web/informacion-poblacion-vulnerable"><span class="enfasis_num">8.5.</span>Información para población con discapacidad</a></li>
                                </ol>
                            </div>
                        </div>
                    </div>
        ...
        <style>
            ...
            .cpnt-2 .enlace .btn-transparencia {
                color: #FFFFFF;
        ...
        <div class="cpnt cpnt-2">
            <div class="texto">
                <p class="paragraph p-1"><b>¿La información sobre Transparencia y Acceso a la Información Pública te fue útil?</b></p>
            </div>
            <div class="enlace">
                <p class="paragraph p-1">Contesta esta corta encuesta y comparte tu opinión <a class="btn btn-transparencia" href="https://docs.google.com/forms/d/1wOiMxHf2IKU_xzBZ9KN_a2ZoxZMTUkrBYFEr08jLCec/" rel="noopener noreferrer" target="_blank"> aquí.</a></p>
            </div>
        </div>
    </div>
</div>
