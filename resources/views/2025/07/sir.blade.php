    ...
    <div class="cpnt-3" id="presentacion">
        <div class="wrapper">
            ...
            <div class="texto">
                ...
                <p>Con la entrada en operación de la primera línea del Metro de Bogotá (L1MB) se requiere la integración del medio de pago entre el actual sistema de transporte y el sistema metro, permitiendo la interoperabilidad tecnológica y financiera del recaudo entre los sistemas de transporte y sus operadores.</p>
    ...
    <div class="cpnt-2" id="noticias">
        <div class="wrapper">
            ...
            <div class="cards">
                ...
                <div class="card">
                    <img class="card-img-top" src="https://www.movilidadbogota.gov.co/web/sites/default/files/Noticias/10-09-2025/1.jpg" alt="Card image cap">
                    <div class="card-body">
                        <h5 class="card-title">Hacia una movilidad integrada: Bogotá avanza en el Sistema Interoperable de Recaudo</h5>
                        <p class="card-text">Bogotá da un paso trascendental hacia la consolidación de una movilidad más moderna e innovadora con la implementación del Sistema Interoperable de Recaudo (SIR).</p>
                        <a href="https://www.movilidadbogota.gov.co/web/noticia/hacia_una_movilidad_integrada_bogota_avanza_en_el_sistema_interoperable_de_recaudo" class="btn btn-primary">Leer más</a>
                    </div>
                </div>
                <div class="card">
        ...
        <div class="wrapper">
            ...
            <div class="documentos">
                <ul>
                    ...
                    <li><a href="/img/sir/sesion_1.pptx" target="_blank" rel="noopener noreferrer">Visión y Gobernanza (.pptx)</a></li>
                    <li><a href="/img/sir/sesion_2.pptx" target="_blank" rel="noopener noreferrer">Estandar interoperabilidad y unidades (.pptx)</a></li>
                    <li><a href="/img/sir/sesion_3.pptx" target="_blank" rel="noopener noreferrer">Sistema central y sus interfaces (.pptx)</a></li>
                    <li><a href="/img/sir/sesion_4.pptx" target="_blank" rel="noopener noreferrer">Camara de compensacion y sus interfaces (.pptx)</a></li>
                </ul>
            </div>
