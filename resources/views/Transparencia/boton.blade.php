...
<!-- Set transparencia -->
<div class="set-wrapper transparencia">
    <!-- ----- ----- ----- ----- ----- ----- ----- -----  Fuente Montserrat -----  ----- ----- ----- ----- ----- ----- ----- ----- ------ -->
                                    ...
                                    <ol>
                                        <li><span class="enfasis_num">7.1.</span>Instrumentos de gestión de la información
                                            ...
                                            <ol>
                                                ...
                                                <li><a href="https://www.movilidad
                                                bogota.gov.co/web/tipos_de_datos_o_informacion_clasificada_o_reservada" rel="noopener noreferrer" target="_blank"><span class="enfasis_num">7.1.4.</span>Tipos de datos - Información clasificada o reservada</a></li>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div aria-labelledby="headingOcho" class="panel-collapse collapse" id="collapseOcho" role="tabpanel">
                                <div class="panel-body">
                                    ...
                                    <ol>
                                        <li><a href="https://www.movilidadbogota.gov.co/web/informacion_para_ninos_ninas_y_adolescentes"><span class="enfasis_num">8.1.</span>Información para niños, niñas y adolescentes</li>
                                        ...
                                        <li><a href="https://www.movilidadbogota.gov.co/web/informacion_para_sector_social_lgtbi" target="_blank" rel="noopener noreferrer"><span class="enfasis_num">8.3.</span>Información para el Sector Social LGTBI</a></a></li>
