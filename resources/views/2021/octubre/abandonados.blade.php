...
<style type="text/css">
    ...
    .encabezado {
        ...
        border-bottom: solid 5px #BED000;
    }
    ...
    .bloque-1 {
        background-image: url('https://www.movilidadbogota.gov.co/web/sites/default/files/Temas/2021-10-15/abandonados_2.jpg');
    ...
    .bloque-2 .titulo-1 h4 {
        color: #151515;
        font-size: 16px;
        font-weight: 600;
        padding: 20px;
        text-shadow: 5px -2px 5px rgba(150, 150, 150, 1);
        border-top: solid 3px #4d541f;
    ...
    .bloque-2 .b2-img {
        ...
        background-image: url('https://www.movilidadbogota.gov.co/web/sites/default/files/Temas/2021-10-15/abandonados_1.jpg');
        background-size: cover;
    ...
    .bloque-4 .container-fluid {
        ...
        border-top: solid 5px #BED000;
    }

    .bloque-4 .container-fluid .b4-footer {
        text-align: center;
        padding: 15px;
    }
    ...
    .bloque-4 .container-fluid .b4-footer p {
        margin: 0px;
        font-family: 'Sora', sans-serif;
        color: #fff;
        padding: 15px;
    ...
    .bloque-4 .container-fluid .b4-footer p a {
        margin: 0px;
        font-family: 'Sora', sans-serif;
        color: #fff;
        padding: 15px;
    ...
    .bloque-4 .container-fluid .b4-footer h3 {
        margin: 0px;
        font-family: 'Sora', sans-serif;
        color: #BED000;
        padding: 15px;
...
<!-- Set abandonados -->
<div class="set-wrapper abandonados">
    <div class="seccion">
